...
class _ClientManager:
    ...
    def configure(
        ...
        *,
        ...
        `VITE_GEMINI_API_KEY` environment variable is set, it will be used as the API key. If not,
        ...
        Args:
            ...
            api_key: The API-Key to use when creating the default clients (each service uses
                ...
                If omitted, and the `VITE_GEMINI_API_KEY` or the `GOOGLE_API_KEY` environment variable
        ...
        if had_api_key_value:
            ...
            if not api_key:
                # If the VITE_GEMINI_API_KEY doesn't exist, attempt to load the
